...
export function ContactPage() {
  usePublicMetadata({
    title: "Contact | Lounge Hall",
    description: "Contact UltraScaling Solutions about Lounge Hall product inquiries, support, partnerships, or a product demonstration.",
  });
    ...
    <main className="public-contact">
      ...
      <section className="public-contact-content"><div className="public-container public-contact-layout">
        <section className="public-contact-info" aria-labelledby="contact-information-title">
          ...
          <p>We build Lounge Hall and the tools that help entertainment lounges run smoothly.</p>
