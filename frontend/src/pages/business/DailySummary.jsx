...
import { formatCurrency, formatDate, formatHours, shiftDate } from "../../utils/analytics";

export function DailySummary({ date, businessDate, onDateChange }) {
  ...
  return (
    <>
      <KpiGrid items={[
        ...
        { label: "Peak Activity", value: `${metrics.peakActivity} sessions`, description: metrics.peakActivity ? `Busiest completion hour: ${peakLabel}` : "No completed traffic yet", icon: "^" },
