    ...
    try {
      ...
      const result = mode === "signin"
        ...
        : await supabase.auth.signUp({
          ...credentials,
          options: { data: { business_name: form.businessName.trim() || "My Lounge" } },
        });
      if (result.error) {
  ...
  return (
    <main className="auth-page">
      <section className="auth-card" aria-labelledby="auth-title">
        ...
        <h1 id="auth-title">{mode === "signin" ? "Welcome back" : "Create your lounge"}</h1>
        <p>{mode === "signin" ? "Sign in to manage live sessions and business performance." : "Set up a secure owner account for your lounge."}</p>
