export function PeriodNavigator({ label, onPrevious, onNext, onCurrent, children, currentLabel, nextDisabled = false }) {
  return (
    <div className="period-navigator" aria-label={`${label} navigation`}>
      ...
      <button type="button" onClick={onNext} disabled={nextDisabled} aria-label={`Next ${label}`}>&rarr;</button>
